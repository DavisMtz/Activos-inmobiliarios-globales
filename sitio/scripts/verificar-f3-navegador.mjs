...
try {
  ...
  if (!remoto || !existsSync(assets)) {
    ...
    const MARCAS = ["Pegar texto de Facebook", "Hacer portada", "Mandar a la papelera", "Contraseña temporal", "Qué busca la gente", "Solo los que faltan por cerrar", "Secciones del panel"];
